...
app.config['MAIL_DEFAULT_SENDER'] = 'hamsagirish27@gmail.com'  # Default sender address
app.config['MAIL_PASSWORD'] = 'wznkvqvgzjdoruos'  # The 16-character app password generated by Google => need to do 2 step verification
...
def accept_alumni_requests(id):
    ...
    recipient = session["hamsagirish27@gmail.com"] 
